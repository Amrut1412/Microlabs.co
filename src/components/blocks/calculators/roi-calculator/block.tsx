...
export function Block() {
  ...
  const calculateMicrolabsCost = (size: number) => {
  ...
  const microlabsCost = calculateMicrolabsCost(teamSize);
  const competitionCost = monthlySpend;
  const monthlySavings = competitionCost - microlabsCost;
      ...
      <Container maxW="6xl">
        ...
        <VStack maxW="6xl" mx="auto" textAlign="center" gap={{ base: '4', md: '6' }} mb={'8'}>
          ...
          <Heading as="h2" textStyle={{ base: '3xl', md: '5xl' }} fontWeight="bold">
            The Real Cost of NOT Using Microlabs
          </Heading>
